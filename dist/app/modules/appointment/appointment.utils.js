...
const createAppointmentConfirmationEmail = (data) => {
    const bookingLink = `${config_1.default.frontend_base_url}/book/${data.counselorId}`;
    return `
    <!DOCTYPE html>
    <html>
    <head>
...
exports.default = AppointmentUtils;
